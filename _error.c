...
/**
 * print_str_to_stderr - prints an input string to stderr
...
/**
 * print_char_to_fd - writes the character c to given file descriptor
 * @c: The character to print
...
/**
 * print_str_to_fd - prints an input string to given file descriptor
 * @str: the string to be printed
 * @fd: the file descriptor to write to
 *
